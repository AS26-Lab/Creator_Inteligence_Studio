        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = dispatch(
                ...
                clip_service=SimpleNamespace(
                    get_ranking_run=lambda *args, **kwargs: SimpleNamespace(status=SimpleNamespace(value="not_ranked"), is_stale=False, run=None, candidates=(), available_sources=(), missing_sources=(), warnings=(), errors=()),
                    rank_clip_candidates=lambda *args, **kwargs: SimpleNamespace(status=SimpleNamespace(value="not_ranked"), is_stale=False, run=None, candidates=(), available_sources=(), missing_sources=(), warnings=(), errors=()),
                    ...
                    create_clip_collection=lambda *args, **kwargs: SimpleNamespace(id="", name=""),
