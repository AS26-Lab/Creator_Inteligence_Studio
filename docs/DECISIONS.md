...
| 2026-07-23 | Entregas de subtitulos | Las entregas sidecar o burn-in toman un snapshot del track, del estilo y de la configuracion de render sin mutar el track editorial. | El historial de render y el historial editorial quedan separados; sidecar no recodifica el MP4 y burn-in produce un nuevo MP4 verificable. | Sobrescribir subtitulos editados, generar entregas sin verificar o usar el track actual sin snapshot. |
| 2026-07-24 | Creator Memory | La memoria del creador sera estructurada, versionada y revisable, con evidencia, contradicciones y snapshots separados del resto de analitica. | El perfil creativo puede consultarse y editarse sin convertir observaciones aisladas en reglas automaticas. | Generacion automatica de perfil, reglas ocultas o fusion con analytics/experiments. |
| 2026-07-25 | Creator Language | El analisis de lenguaje y narrativa sera local, determinista y revisable, y solo propondria candidatos hacia Creator Memory. | Se preservan fuentes locales, perfiles narrativos versionados y evidencia trazable sin mutar la memoria automaticamente. | LLM, ML, embeddings externos, mutacion silenciosa de Creator Memory o generacion de guiones. |
| 2026-07-25 | Thumbnail Lab and Titles | El analisis de packaging creativo evaluara titulos y miniaturas de forma local, determinista y trazable, usando memoria creativa, analisis de lenguaje y rendimiento historico. | Se puede razonar sobre marca, contenido, plataforma, referencias y riesgo sin generar imagenes ni editar capas automaticamente. | Generacion integrada de imagenes, editor de imagenes, scraping, copiado de estilos ajenos o decision automatica sin revision. |
| 2026-07-25 | YouTube Read-Only Integration | La primera integracion oficial de YouTube se limitara a OAuth de escritorio y scopes de lectura para importar canales, videos, miniaturas y metricas oficiales sin permisos de escritura. | La aplicacion puede sincronizar datos remotos y conservar trazabilidad local sin subir, editar o borrar contenido de YouTube. | Scopes de escritura, edicion remota, comentarios, monetizacion o automatizacion de publicacion. |
| 2026-07-27 | TikTok Read-Only Integration | La integracion oficial de TikTok se limitara a Login Kit, OAuth de escritorio y Display API en modo solo lectura para importar perfil, videos publicos propios, metadatos y contadores publicos compatibles. | La aplicacion conserva historial local, cursor, sincronizacion incremental y evidencia de aprobacion sin subir, editar ni borrar contenido de TikTok. | Content Posting API, Upload API, Research API, scraping, comentarios, mensajes o cualquier scope de escritura. |
...
Decision: [`docs/CONTENT_BRIEF_AND_PRE_PRODUCTION_FOUNDATION.md`](docs/CONTENT_BRIEF_AND_PRE_PRODUCTION_FOUNDATION.md) keeps briefs, readiness and preproduction local, human-reviewed and non-executable.
