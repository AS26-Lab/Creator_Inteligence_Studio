...
def default_metric_definitions() -> tuple[AnalyticsMetricDefinitionSpec, ...]:
    ...
    return (
        ...
        AnalyticsMetricDefinitionSpec("new_viewers", "New viewers", discovery, "count", numeric, sum_, True, "Espectadores nuevos observados.", ("new_viewers", "new viewers", "nuevos espectadores"), youtube_family + short_video_platforms),
        ...
        AnalyticsMetricDefinitionSpec("search_views", "Search views", discovery, "count", numeric, sum_, True, "Vistas provenientes de busqueda.", ("search_views", "search views", "vistas por busqueda"), all_platforms),
        AnalyticsMetricDefinitionSpec("suggested_views", "Suggested views", discovery, "count", numeric, sum_, True, "Vistas provenientes de sugeridos.", ("suggested_views", "suggested views", "vistas sugeridas"), youtube_family + short_video_platforms),
        AnalyticsMetricDefinitionSpec("browse_views", "Browse views", discovery, "count", numeric, sum_, True, "Vistas provenientes de browse.", ("browse_views", "browse views", "vistas en browse"), youtube_family),
        AnalyticsMetricDefinitionSpec("shorts_feed_views", "Shorts feed views", discovery, "count", numeric, sum_, True, "Vistas provenientes del feed de shorts.", ("shorts_feed_views", "shorts feed views"), ("youtube_short",)),
        AnalyticsMetricDefinitionSpec("external_views", "External views", discovery, "count", numeric, sum_, True, "Vistas provenientes de fuentes externas.", ("external_views", "external views", "vistas externas"), all_platforms),
        AnalyticsMetricDefinitionSpec("direct_views", "Direct views", discovery, "count", numeric, sum_, True, "Vistas directas observadas.", ("direct_views", "direct views", "vistas directas"), all_platforms),
        AnalyticsMetricDefinitionSpec("notification_views", "Notification views", discovery, "count", numeric, sum_, True, "Vistas desde notificaciones.", ("notification_views", "notification views"), youtube_family),
        AnalyticsMetricDefinitionSpec("playlist_views", "Playlist views", discovery, "count", numeric, sum_, True, "Vistas desde listas de reproduccion.", ("playlist_views", "playlist views"), youtube_family),
        ...
        AnalyticsMetricDefinitionSpec("device_share", "Device share", context, "percent", numeric, avg, None, "Distribucion por dispositivo.", ("device_share", "device share"), all_platforms),
        AnalyticsMetricDefinitionSpec("geography_share", "Geography share", context, "percent", numeric, avg, None, "Distribucion geografica observada.", ("geography_share", "geography share"), all_platforms),
        AnalyticsMetricDefinitionSpec("subscription_status_share", "Subscription status share", context, "percent", numeric, avg, None, "Distribucion por estado de suscripcion.", ("subscription_status_share", "subscription status share"), youtube_family + social_platforms),
