...
def build_navigation_items() -> list[NavigationItem]:
    ...
    return [
        ...
        NavigationItem("production_overview", "Production Preparation"),
        NavigationItem("production_requests", "Requests"),
        NavigationItem("production_outlines", "Script Outlines"),
        NavigationItem("production_outline_detail", "Outline Structure"),
        NavigationItem("production_beats", "Beats"),
        NavigationItem("production_segments", "Segments"),
        NavigationItem("production_claims_proof", "Claims & Proof"),
        NavigationItem("production_scenes", "Scenes"),
        NavigationItem("production_shots", "Shots"),
        NavigationItem("production_shot_groups", "Shot Groups"),
        NavigationItem("production_recording_blocks", "Recording Blocks"),
        NavigationItem("production_recording_order", "Recording Order"),
        NavigationItem("production_visual_cues", "Visual Cues"),
        NavigationItem("production_audio_cues", "Audio Cues"),
        NavigationItem("production_on_screen_text", "On-Screen Text"),
        NavigationItem("production_broll", "B-Roll"),
        NavigationItem("production_graphics", "Graphics"),
        NavigationItem("production_screen_recordings", "Screen Recordings"),
        NavigationItem("production_participants", "Participants"),
        NavigationItem("production_locations", "Locations"),
        NavigationItem("production_props", "Props"),
        NavigationItem("production_wardrobe", "Wardrobe"),
        NavigationItem("production_equipment", "Equipment"),
        NavigationItem("production_continuity", "Continuity"),
        NavigationItem("production_variants", "Platform Variants"),
        NavigationItem("production_reusable_segments", "Reusable Segments"),
        NavigationItem("production_dependencies", "Dependencies"),
        NavigationItem("production_milestones", "Milestones"),
        NavigationItem("production_checklists", "Checklists"),
        NavigationItem("production_readiness", "Readiness"),
        NavigationItem("production_risks", "Risks"),
        NavigationItem("production_reviews", "Reviews"),
        NavigationItem("production_history", "History"),
        NavigationItem("production_settings", "Settings"),
        NavigationItem("production_privacy", "Privacy"),
